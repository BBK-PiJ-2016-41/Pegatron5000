...
object PegFactoryImpl: PegFactory {
     ...
     */
    override fun makePegs(input: MutableList<Colour>): PegList {
     ...
     */
    override fun generateSequence(num : Int) : ArrayList<Colour> {
     ...
     */
    override fun findAvailableColours() : MutableList<Colour> {
     ...
     */
    override fun interpretUserInput(userInput : String, numPegs: Int) : MutableList<Colour> {
